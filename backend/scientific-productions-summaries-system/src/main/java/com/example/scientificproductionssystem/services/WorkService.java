...
public class WorkService {
    ...
    public Page<WorkDetailsDTO> findWithParams(Integer page, Integer limit, Integer startYear, Integer endYear, List<Long> ids, String type) {
        List<Work> works;
        ...
        works = repository.findAllByDateOrInstituteOrResearcherIdsOrType(ids, startYear, endYear, type);
