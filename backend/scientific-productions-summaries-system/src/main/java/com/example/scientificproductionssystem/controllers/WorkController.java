...
//    }
    ...
    public ResponseEntity<Page<WorkDetailsDTO>> findWithParams(@RequestBody @Nullable List<Long> ids,
                                                    ...
                                                    @RequestParam(name = "type", required = false, defaultValue = "all") String type)
    {
        return ResponseEntity.ok(service.findWithParams(page, limit, startYear, endYear, ids, type));
    }
